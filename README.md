...
We provide every programmatic endpoint required to build sophisticated document workflows. Explore the full suite of our processing capabilities below.

| Category | Available API Endpoints |
|---|---|
| **Convert** | [Convert to PDF](https://pdfrest.com/apitools/convert-to-pdf/) • [Convert to PDF/A](https://pdfrest.com/apitools/convert-to-pdfa/) • [Convert to PDF/X](https://pdfrest.com/apitools/convert-to-pdfx/) • [PDF to Word](https://pdfrest.com/apitools/pdf-to-word/) • [PDF to Excel](https://pdfrest.com/apitools/pdf-to-excel/) • [PDF to PowerPoint](https://pdfrest.com/apitools/pdf-to-powerpoint/) • [PDF to Images](https://pdfrest.com/apitools/pdf-to-images/) • [PDF to Markdown](https://pdfrest.com/apitools/pdf-to-markdown/) |
| **Optimize** | [Compress PDF](https://pdfrest.com/apitools/compress-pdf/) • [Linearize PDF](https://pdfrest.com/apitools/linearize-pdf/) • [Flatten Transparencies](https://pdfrest.com/apitools/flatten-transparencies/) • [Flatten Layers](https://pdfrest.com/apitools/flatten-layers/) • [Flatten Annotations](https://pdfrest.com/apitools/flatten-annotations/) • [Convert PDF Colors](https://pdfrest.com/apitools/convert-pdf-colors/) • [Rasterize PDF](https://pdfrest.com/apitools/rasterize-pdf/) |
| **Secure** | [Encrypt PDF](https://pdfrest.com/apitools/encrypt-pdf/) • [Restrict PDF](https://pdfrest.com/apitools/restrict-pdf/) • [Sign PDF](https://pdfrest.com/apitools/sign-pdf/) • [Redact PDF](https://pdfrest.com/apitools/redact-pdf/) • [Watermark PDF](https://pdfrest.com/apitools/watermark-pdf/) • [TDM Reserve PDF](https://pdfrest.com/apitools/tdm-reserve-pdf/) |
| **Extract** | [OCR PDF](https://pdfrest.com/apitools/ocr-pdf/) • [Extract Text](https://pdfrest.com/apitools/extract-text/) • [Extract Images](https://pdfrest.com/apitools/extract-images/) • [Query PDF](https://pdfrest.com/apitools/query-pdf/) |
| **Modify** | [Merge PDFs](https://pdfrest.com/apitools/merge-pdfs/) • [Split PDF](https://pdfrest.com/apitools/split-pdf/) • [Add to PDF](https://pdfrest.com/apitools/add-to-pdf/) |
| **Forms** | [Flatten Forms](https://pdfrest.com/apitools/flatten-forms/) • [Import Form Data](https://pdfrest.com/apitools/import-form-data/) • [Export Form Data](https://pdfrest.com/apitools/export-form-data/) |
| **Analyze** | [Summarize PDF](https://pdfrest.com/apitools/summarize-pdf/) • [Translate PDF](https://pdfrest.com/apitools/translate-pdf/) |
| **Simplify** | [Upload Files](https://pdfrest.com/apitools/upload-files/) • [Zip Files](https://pdfrest.com/apitools/zip-files/) • [API Polling](https://pdfrest.com/apitools/api-polling/) • [Delete Files](https://pdfrest.com/apitools/delete-files/) |
...
When you need help you talk to actual developers. Reach out to our [Engineering Support Team](https://pdfrest.com/support/) to overcome integration hurdles or discuss complex PDF processing challenges.
